...
## Description
A blog-style site similar to wordpress where developers can publish blog posts and comment on other developers' blog posts. The application is able to create, read, update, and delete blog posts at will as long as the user is logged in. It includes a login encryption system from bcrypt to facilitate authentication credentials. 
